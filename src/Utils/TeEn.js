  ...
  stories: [
    {
      ...
      parts: {
        card: [
          {
            id: "1",
            title: {en:"Early Life in Gokul and Vrindavan",te:"గోకుల మరియు వృందావనంలో మొదటి జీవితం"},
            date: {en:"December 11, 2024",te:"2024 డిసెంబర్ 11"},
            thumbnailImage: "",
            coverImage: cardOne,
            description:
              {en:"This chapter in Krishna's life sets the stage for the eventual downfall of Kamsa and the restoration of dharma.",te:"కృష్ణుడి జీవితంలో ఈ అధ్యాయం కంసుని పతనానికి మరియు ధర్మాన్ని పునరుద్ధరించడానికి మార్గం సిద్ధం చేస్తుంది."},
